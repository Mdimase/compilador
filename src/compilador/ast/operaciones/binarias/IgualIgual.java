...
public class IgualIgual extends ComparacionIgualdad{

    public IgualIgual(Expresion izquierda, Expresion derecha) {
        super(izquierda, derecha, "==");
    }

    public IgualIgual(Expresion izquierda, Expresion derecha, Tipo tipo) {
